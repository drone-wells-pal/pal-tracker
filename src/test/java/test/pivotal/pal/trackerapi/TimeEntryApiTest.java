...
@SpringBootTest(classes = PalTrackerApplication.class, webEnvironment = RANDOM_PORT, properties = {"WELCOME_MESSAGE=Hello from test"})
public class TimeEntryApiTest {
    ...
    private TimeEntry timeEntry = new TimeEntry(123, 456, LocalDate.now(), 8);
    ...
    public void testCreate() throws Exception {
        ...
        assertThat(createJson.read("$.date", String.class)).isEqualTo(LocalDate.now().toString());
    ...
    public void testRead() throws Exception {
        ...
        assertThat(readJson.read("$.date", String.class)).isEqualTo(LocalDate.now().toString());
    ...
    public void testUpdate() throws Exception {
        Long id = createTimeEntry();
        TimeEntry updatedTimeEntry = new TimeEntry(2, 3, LocalDate.now().plusDays(1), 9);
        ...
        assertThat(updateJson.read("$.date", String.class)).isEqualTo(LocalDate.now().plusDays(1).toString());
